/* -*- c++ -*- */
#ifndef LJSCEEXCLUDEFORCE_H
#define LJSCEEXCLUDEFORCE_H
...
namespace ProtoMol {
  //____ LJSCEExcludeForce
  class LJSCEExcludeForce {
  public:
    enum {DIST_R2 = 1};
    enum {CUTOFF = 0};
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  public:
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // New methods of class LJSCEExcludeForce
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  public:
    void operator()(Real &energy, Real &force,
      ...
      if (rDistSquared < 1.0 / 0.25)
        report << warning << "LJSCEExcludeForce::operator(): atom " << atom1 <<
        " and " << atom2 << " get closer"
                << " than 0.5 angstroms (=" <<
        sqrt(1.0 / rDistSquared) << ")." << endr;
#endif
      //test for same residue, exclusion for cells SCE
      if(topo->atoms[atom1].residue_seq == topo->atoms[atom2].residue_seq){
        energy = force = 0.0;
        return;
      }
    ...
    static LJSCEExcludeForce make(const std::vector<Value> &) {
      return LJSCEExcludeForce();
    }
